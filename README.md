...
Since this application is not available on the App Store, you will need to clone the repository and download it using XCode, or install the application using the `TodoTrackr.ipa` file with a sideloading tool like [AltStore](https://altstore.io/).
